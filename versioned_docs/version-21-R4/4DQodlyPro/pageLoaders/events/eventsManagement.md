...
<Column.List align="center" justifyContent="between">
    <Column.Item width="50%">
        <ul>
            <li>Exposed <a href="https://developer.4d.com/docs/ORDA/ordaClasses#datastore-class">datastore class functions</a> distinguishable by the keyword <code>Datastore</code>.</li>
        </ul>
    </Column.Item>
    <Column.Item width="49%">
...
<Column.List align="center" justifyContent="between">
    <Column.Item width="50%">
        <ul>
            <li>Exposed <a href="https://developer.4d.com/docs/ORDA/ordaClasses#dataclass-class">dataclass class functions</a> distinguishable by the keyword <code>Dataclass Name</code>.</li>
        </ul>
    </Column.Item>
    <Column.Item width="49%">
...
<Column.List align="center" justifyContent="between">
    <Column.Item width="50%">
        <ul>
            <li>Exposed <a href="https://developer.4d.com/docs/ORDA/ordaClasses#entity-class">entity class functions</a> and <a href="https://developer.4d.com/docs/ORDA/ordaClasses#entityselection-class">entity selection class functions</a>, distinguished by the <code>Namespace Of Qodly Source</code> keyword, encompass shared functions when these entities serve as shared qodlysources.</li>
        </ul>
    </Column.Item>
    <Column.Item width="49%">
...
<Column.List align="center" justifyContent="between">
    <Column.Item width="50%">
        <ul>
            <li>Exposed <a href="[https://developer.4d.com/docs/Concepts/classes#singleton-classes](https://developer.4d.com/docs/Concepts/classes#singleton-classes)">singleton class functions</a>, distinguished by the <code>Page</code> keyword.</li>
        </ul>
    </Column.Item>
    <Column.Item width="49%">
