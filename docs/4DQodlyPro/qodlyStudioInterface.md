...
**Qodly Studio** is a seamless, 100% web-based development experience, which empowers developers to:

- Effortlessly link data with [ORDA](https://developer.4d.com/docs/ORDA/ordaClasses) dataclasses.
