...
The **Restrict Access by default** selector <img src={require('./img/restric-mode.png').default} style={{borderRadius: '6px'}} /> allows you to configure how resources (i.e. datastore, attributes, functions, etc.) are accessed when no specific permission is defined for them:
